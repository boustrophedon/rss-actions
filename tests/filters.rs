...
fn display_no_filters() {
    ...
    assert_eq!(message, vec!["No filters in database."]);
}
...
fn same_feed_different_keywords() {
    ...
    assert_eq!(message,
        vec!["Current filters:", "",
        "example_1\ttest\tprint_data\tNever updated",
        // note that keywords here are in alphabetical order, not the order they were passed in
        "example_1\tother_keyword, test\tprint_data\tNever updated",
        ]);
}
...
fn same_feed_same_filters_different_script() {
    ...
    assert_eq!(message,
        vec!["Current filters:", "",
        "example_1\ttest\tprint_data\tNever updated",
        "example_1\ttest\tfalse\tNever updated",
        ]);
}
...
fn same_filters_different_feed_aliases() {
    ...
    assert_eq!(message,
        vec!["Current filters:", "",
        "example_1\ttest\tprint_data\tNever updated",
        "example_2_org\tother_keyword, test\tprint_data\tNever updated",
        ]);
}
